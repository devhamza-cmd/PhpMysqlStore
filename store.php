...
<body style=' background-color: rgb(236, 236, 236);'>
   <div class="d-flex justify-content-between">
    ...
    <div>
      ...
      <div><a href="stores.php"><i class="h icon2 fa-solid fa-store"></i></a></div>
      <div><a href="commande.php"><i class="icon2 fa-solid fa-truck-fast"></i></a></div>

      <div><a href="compte.php"><i class="icon2 ps-1 fa-solid fa-user"></i></a></div>
    ...
    <div class=" two">
     <nav class='sticky-top first '>
          <div>
            <div class=" p-5 nitem"><a class="nav-link"><i
                  class="fa-solid fa-shop pe-2"></i>STORE X</a></div>
            ...
            <div class="nitem"><a class="nav-link" href="commande.php"><i
                  ...
                  <div class="nitem"><a class="nav-link" href="community.php"><i class="fa-sharp  fa-retweet pe-2"></i></i>community</a></div>
